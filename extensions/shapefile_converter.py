...
class ShapefileConverter:
    ...
    def register(self):
        print('Registering Shapefile converter extension')
        ...
        def receive_files(message):
            with self.flask_app.app_context():
                ...
                found_shape_files = []
                row = 0
                for shapefile_name in glob.glob(directory + os.path.sep + "*.shp"):
        ...
        def receive_energyasset_info(shapefile_energyasset_list):
            with self.flask_app.app_context():
                ...
                for shapefile_energyasset in shapefile_energyasset_list:
                    ...
                    self.process_shapefile(area, shapefile_name_base, energy_asset)
