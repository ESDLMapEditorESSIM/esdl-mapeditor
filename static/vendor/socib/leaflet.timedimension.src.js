...
L.TimeDimension.Layer.GeoJson = L.TimeDimension.Layer.extend({
    ...
    _update: function() {
        ...
        var layers = this._baseLayer.getLayers();       // Dit geeft 1992 layers terug, 83 lijnstukken * 24 uur
        var k=0;
        for (var i = 0, l = layers.length; i < l; i++) {
//            var feature = this._getFeatureBetweenDates(layers[i].feature, minTime, maxTime);  // 166 results
            var feature = this._getFeatureBetweenDates(layers[i].feature, minTime, maxTime-1);  // 83 results
            if (feature) {
